...
class CoMPM(nn.Module):
    def __init__(self, context_type, speaker_type, freeze):
        ...
        self.speakerGRU = nn.GRU(self.speaker_hiddenDim, self.speaker_hiddenDim, 2,
    ...
    def forward(self, batch_input_tokens, batch_speaker_tokens):
        ...
        hidden_states = batch_context_output + self.SC(batch_speaker_output)
